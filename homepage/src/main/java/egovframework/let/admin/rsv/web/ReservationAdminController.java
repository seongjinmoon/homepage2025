...
public class ReservationAdminController {
	...
	/*	
	//예약정보 상세
	@RequestMapping(value = "/admin/rsv/rsvSelect.do")
	public String rsvSelect(@ModelAttribute("searchVO") ReservationVO searchVO, HttpServletRequest request, ModelMap model) throws Exception{
		LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
		model.addAttribute("USER_INFO", user);
